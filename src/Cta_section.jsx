      ...
      <div className=" border mx-20 bg-gray-800 border-gray-700 rounded-3xl relative isolate overflow-hidden">
        ...
        <div className=" py-32 px-24 gap-x-20 ">
          ...
          <div className="mt-10 flex items-center gap-x-6">
            <a
              href="#"
              className=" px-3.5 py-2.5 font-semibold bg-gray-700 hover:bg-gray-600 border border-gray-600 rounded-md hover:border-gray-600"
            >
              Get started
            </a>
        ...
        <div className=" mt-8 ">
          <img
            ...
            alt=""
            className="absolute left-170 top-15 w-228 rounded-md max-w-none"
          />
        </div>
      </div>
    </main>
